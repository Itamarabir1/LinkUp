...
- [architecture/REALTIME.md](architecture/REALTIME.md) — WebSocket, Redis Pub/Sub, צ'אט, **user:\*:events**, **ChatMessageSchema** (Zod) + מיפוי ל-MessageResponse; חוזי JSON (נסיעות, מיקום, typing, user events) ליישור פרונט–שרת
