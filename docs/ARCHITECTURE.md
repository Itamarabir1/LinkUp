...
- **CI/CD:** [`backend-ci.yml`](../.github/workflows/backend-ci.yml) (פריסת stack ל־EC2 לפי path filters) ו־[`frontend-ci.yml`](../.github/workflows/frontend-ci.yml) + [`deploy-frontend-ec2.yml`](../.github/workflows/deploy-frontend-ec2.yml) (`workflow_run` אחרי Frontend CI מוצלח על `main`) — טבלה ופירוט ב־[`docs/DEPLOYMENT.md`](DEPLOYMENT.md)
