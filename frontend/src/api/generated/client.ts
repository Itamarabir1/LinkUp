 ...
 */
const markNotificationsReadApiV1UsersMeNotificationsReadPatch = (
    markNotificationsReadRequest: MarkNotificationsReadRequest,
 options?: SecondParameter<typeof apiMutator<void>>,) => {
      return apiMutator<void>(
      {url: `/api/v1/users/me/notifications/read`, method: 'PATCH',
      headers: {'Content-Type': 'application/json', },
 ...
 */
const markAllNotificationsReadApiV1UsersMeNotificationsReadAllPatch = (

 options?: SecondParameter<typeof apiMutator<void>>,) => {
      return apiMutator<void>(
      {url: `/api/v1/users/me/notifications/read-all`, method: 'PATCH'
    },
      options);
    }
...
export type MarkNotificationsReadApiV1UsersMeNotificationsReadPatchResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getLinkUpAPI>['markNotificationsReadApiV1UsersMeNotificationsReadPatch']>>>
export type MarkAllNotificationsReadApiV1UsersMeNotificationsReadAllPatchResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getLinkUpAPI>['markAllNotificationsReadApiV1UsersMeNotificationsReadAllPatch']>>>
